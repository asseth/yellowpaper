...
En considérant l'utilisation de fonctions existantes, une fonction $f$ étant donnée, la fonction $f^*$ représente une version similaire element-wise(TODO), de la fonction de mapping plutôt qu'entre les séquences. Cela est précisément décrit dans la section \ref{ch:block}.
