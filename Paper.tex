...
De manière générale, Ethereum implémente ce paradigme. Ethereum fournit un grand nombre de telles ressources, chacune possédant un état distinct et un code fonctionnel, mais en plus capable d'intéragir entre elles au travers d'un framework d'envoi de messages. Nous discutons de sa conception, des problèmes de conception, des opportunités que cela fournit et les futurs obstacles que nous envisageons.
\end{abstract}
...
Alors que le système est décentralisé et que chaque parties a un eopportunité de créer un nouveau block sur un ancien bloc pré-existant
