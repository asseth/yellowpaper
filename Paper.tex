...
\item[stateRoot]  Le hash Keccak de 256 bits du noeud racine du (TODO : trie) trie d'état, après que toutes les transactions soient exécutées et que les finalisations soient appliquées; $H_r$.
\item[transactionsRoot] Le hash Keccak de 256 bits du noeud racine de la structure du trie (TODO:trie), peuplé avec chaque transactions dans la section de la liste de transactions du bloc; $H_t$.
